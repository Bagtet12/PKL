                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="judul" type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="" required autocomplete="judul" autofocus>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="visi" type="text" class="form-control @error('visi') is-invalid @enderror" name="visi" value="" required ="" autofocus>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <textarea  class="form-control @error('misi') is-invalid @enderror" name="misi" value="" required ="" autofocus id="" cols="30" rows="7"></textarea>
                                                @error('misi')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <textarea  class="form-control @error('quotes') is-invalid @enderror" name="quotes" value="" required ="" autofocus id="" cols="30" rows="5"></textarea>
                                                @error('quotes')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
