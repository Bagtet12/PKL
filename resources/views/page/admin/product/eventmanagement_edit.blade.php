                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{url('eventsave')}}/{{$event->id}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="link_website" placeholder="boleh diisi boleh tidak" value="{{$event->link_website}}" required autocomplete="" autofocus>
