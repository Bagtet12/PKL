                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{url('creativesave')}}/{{$creative->id}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <img class=""  width="500" src="{{ url('gambar/'.$creative->gambar) }}" alt="belum ada gambar" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="gambar" class="col-md-2 col-form-label text-md-right">Gambar Baru</label>
                                            <div class="col-md-6">
                                                <input id="gambar" type="file" class="form-control" name="gambar" value="{{ url('gambar/'.$creative->gambar) }}"  autocomplete="" autofocus>
