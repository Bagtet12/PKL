                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{url('influencersave')}}/{{$influencer->id}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="nama" type="text" class="form-control @error('link instagram') is-invalid @enderror" name="link_website" value="{{$influencer->link_instagram}}" required autocomplete="" autofocus>
