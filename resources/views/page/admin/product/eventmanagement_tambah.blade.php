                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('eventtambah')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="link_website" placeholder="boleh diisi boleh tidak" value=""  autocomplete="" autofocus>
