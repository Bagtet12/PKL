                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="card">
                                <div class="card-body">
                                    <h4><i class="fa fa-edit"></i> Tambah Creative Video & Broadcasting</h4><hr>
                                    <form method="POST" action="{{route('creative_tambah')}}" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="link_video" value="" autocomplete="" placeholder="Kalau ada link vidio diisi" autofocus>
